...
I1 = read_image("datasets/VOC2007/VOCdevkit/VOC2007/JPEGImages/000030.jpg", ImageReadMode.RGB)
I2 = read_image("datasets/VOC2007/VOCdevkit/VOC2007/JPEGImages/000032.jpg", ImageReadMode.RGB)
...
plt.subplot(1, 2, 1)
plt.imshow(image_1_pca.permute(1, 2, 0).detach().numpy())
plt.title("Image 1 PCA")
plt.axis('off')
plt.subplot(1, 2, 2)
plt.imshow(image_2_pca.permute(1, 2, 0).detach().numpy())
plt.title("Image 2 PCA")
plt.axis('off')
plt.show()
